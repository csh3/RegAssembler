...
parser.add_argument('-n1', type=int, default=10000, help='Number of sampled reads for draft assemblies')
parser.add_argument('-n2', type=int, default=20000, help='Number of sampled reads for polishing assemblies')
...
if args.asm.lower() == "regassembler":
    os.system("rm -rf RegAssembler")
    os.mkdir('RegAssembler')
    d="RegAssembler"
