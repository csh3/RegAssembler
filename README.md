...
```
python Re-sampling.py -r1 readFile_1 -r2 readFile_2 -thr 10 -ho 5 -al 30 -t THREADS -s SAMPLES
```

For datasets sequenced from other illumina platforms (such as **NextSeq 550** and **NovaSeq 6000**):

```
python Re-sampling.py -r1 readFile_1 -r2 readFile_2 -thr 3 -ho 2 -al 20 -t THREADS -s SAMPLES
```

For **simulated** datasets:

```
python Re-sampling.py -r1 readFile_1 -r2 readFile_2 -thr 3 -ho 2 -al 30 -nchi -t THREADS -s SAMPLES
```
