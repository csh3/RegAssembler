...
parser.add_argument('-r1', required=True, help='Fastq file with forward paired reads used for correction')
parser.add_argument('-r2', required=True, help='Fastq file with reverse paired reads used for correction')
...
parser.add_argument('-i', default='complemented.fa', help='Input fasta file to be correctd')
parser.add_argument('-o', default='corrected.fa', help='Output fasta file of the corrected assembly')
